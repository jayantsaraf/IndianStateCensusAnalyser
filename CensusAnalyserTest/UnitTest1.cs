...
namespace CensusAnalyserTest
{
    public class Tests
    {
        ...
        static string indianStateCensusFilePath = @"C:\Users\jayant\source\repos\IndianStateCensusAnalyser\CensusAnalyserTest\CSV files\IndiaStateCensusData.csv";
        static string wrongHeaderIndianCensusFilePath = @"C:\Users\jayant\source\repos\IndianStateCensusAnalyser\CensusAnalyserTest\CSV files\WrongIndiaStateCensusData.csv";
        static string delimiterIndianCensusFilePath = @"C:\Users\jayant\source\repos\IndianStateCensusAnalyser\CensusAnalyserTest\CSV files\DelimiterIndiaStateCensusData.csv";
        ...
        static string indianStateCodeFilePath = @"C:\Users\jayant\source\repos\IndianStateCensusAnalyser\CensusAnalyserTest\CSV files\IndiaStateCode.csv";
        ...
        {
            totalRecord = censusAnalyser.LoadCensusData(indianStateCensusFilePath, CensusAnalyser.Country.INDIA, indianStateCensusHeaders);
            stateRecord = censusAnalyser.LoadCensusData(indianStateCodeFilePath, CensusAnalyser.Country.INDIA, indianStateCodeHeaders);
        ...
        {
            var censusException = Assert.Throws<CensusAnalyserException>(() => censusAnalyser.LoadCensusData(wrongIndianStateCensusFilePath, CensusAnalyser.Country.INDIA, indianStateCensusHeaders));
            var stateException = Assert.Throws<CensusAnalyserException>(() => censusAnalyser.LoadCensusData(wrongIndianStateCensusFilePath, CensusAnalyser.Country.INDIA, indianStateCodeHeaders));
